...
const slotColors = {
  available: 'border-green-300 text-green-700 bg-green-50 hover:bg-green-100',
  booked: 'border-red-300 text-red-700 bg-red-50 cursor-not-allowed opacity-60',
  pending: 'border-yellow-300 text-yellow-700 bg-yellow-50 cursor-not-allowed opacity-60',
  fictitious: 'border-yellow-300 text-yellow-700 bg-yellow-50 cursor-not-allowed opacity-60',
  selected: 'bg-primary-600 text-white border-primary-600 hover:bg-primary-700'
};
